...
<div class="card">
    <h3>Mis ultimas tareas</h3>
    <div class="table-wrap">
        <table class="table">
            <thead><tr><th>Tarea</th><th>Estado de Revision</th><th>Inicio</th><th>Vencimiento</th><th>Estado de Entrega</th></tr></thead>
            <tbody>
            ...
            @empty
                <tr><td colspan="5">Aun no tiene tareas asignadas.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
