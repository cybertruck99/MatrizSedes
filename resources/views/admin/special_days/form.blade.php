<div class="form-grid">
    <div class="form-group"><label class="form-label">Nombre de día especial/festivo</label><input class="form-control" name="name" value="{{ old('name', $day?->name) }}" required></div>
    ...
    <div class="form-group span-2"><label class="form-label">Descripción</label><textarea name="description">{{ old('description', $day?->description) }}</textarea></div>
</div>
